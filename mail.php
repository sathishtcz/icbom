...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icbom@gmail.com';
    $mail->Password   = 'qrzs tccf dmkt eyzh';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    $mail->setFrom('info.icbom@gmail.com', 'Paper Submission System');
    $mail->addAddress('info.icbom@gmail.com', 'Paper Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICBOM Paper Submission - ' . htmlspecialchars($_POST['Paper_Title']);
