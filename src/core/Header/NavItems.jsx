...
const NavItems = ({ ToggleMenu, MenuOpen }) => {
    ...
    return (
        <nav
            className={`
                fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#26B07C] to-[#176E68] transform transition-transform duration-300
        ...
        >
            <div className="p-5">
                ...
                <ul className="flex flex-col mt-12 space-y-4 text-white text-lg">
                    <Link to="/" onClick={ToggleMenu}>
                        <li className={`${location.pathname === '/' ? 'font-bold' : ''}`}>Home</li>
                    </Link>
                    ...
                    <li ref={dropdown1Ref}>
                        ...
                        {dropdown1 && (
                            <ul className="ml-4 mt-2 space-y-1 border-l-2 border-white pl-2">
