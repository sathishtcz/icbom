...
try {
    ...
    $mail->setFrom('info.icbom@gmail.com', 'Contact Submission System');
    $mail->addAddress('info.icbom@gmail.com', 'Contact Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICBOM Contact Submission';
